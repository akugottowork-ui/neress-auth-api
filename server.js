...
app.post('/api/reports', authRequired, (req, res) => {
  ...
  const report = { id: `RPT-${String(operationalData.reports.length + 9).padStart(3, '0')}`, title: title.slice(0, 100), district: district.slice(0, 100), details: details.slice(0, 500), priority: 'High', status: 'New', createdAt: new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' }) };
